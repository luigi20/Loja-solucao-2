                            ...
                            <div class="panel-body">
                                ...
                                <div class="control-group col-md-6">
                                    ...
                                    <div class="control-group col-md-2">
                                        Nome
                                        <br />
                                        <asp:DropDownList ID="ddlVendedor" runat="server"  AppendDataBoundItems ="True" DataSourceID="ODSVendedor" DataTextField="NomeVendedor" DataValueField="IdVendedor" >
                                         <asp:ListItem Selected="True" Text="" Value="-1"></asp:ListItem>
                                        </asp:DropDownList>
                                        <br />
                                        <br />

                                            <asp:Button class="btn btn-success" ID="btnCadastrar" Text="Pesquisar" runat="server" />
                                        <br />
                                        <asp:ObjectDataSource ID="ODSVendedor" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="listarVendedor" TypeName="Loja.Fachada.Fachada.VendedorFachada"></asp:ObjectDataSource>
                                    </div>
                                </div>
                                ...
                                <div class="control-group col-md-12">
                                    ...
                                    <div class="controls">
                                        <br />
                                        <asp:GridView ID="gdvDepartamento" runat="server" AutoGenerateColumns="False" DataKeyNames ="IdVendedor" DataSourceID="ODSVendedor" CellPadding="4" ForeColor="#333333" Width="717px">
